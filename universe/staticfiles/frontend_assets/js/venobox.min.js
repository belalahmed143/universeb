! function(e, t) {
    ...
    function G(e) {
        27 === e.keyCode && K(), B || (37 == e.keyCode && !0 === w && le(j), 39 == e.keyCode && !0 === L && le(T), B = setTimeout((() => {
            B = null
        }), 100))
    }
        ...
        if (e = x, I.innerHTML = e, g = I.querySelectorAll("img"), g.length) {
            ...
            Y(g, (function(t) {
                ...
                Q = new Image, Q.onload = function() {
                    e++, e == g.length && (a.classList.remove("vbox-loading"), J("animated"))
                }, Q.onerror = function() {
                    e++, e == g.length && (a.classList.remove("vbox-loading"), J("animated"))
                }, Q.src = o
            }))
    ...
    function oe(e) {
        if (!y) {
            ...
            a.style.transition = "margin " + t + "ms ease-out, opacity " + t + "ms ease-out", M = v = e.pageY, V = R = e.pageX, N = !0
        }
    }
    ...
    function ne(e) {
        if (N) {
            ...
            let e = r,
                t = !1;
            D = R - V, D < 0 && L && (e = T, t = !0), D > 0 && w && (e = j, t = !0), Math.abs(D) >= 50 && t ? le(e) : (a.style.marginLeft = 0, a.style.opacity = 1)
        }
    }
    ...
    function de(l) {
        ...
        }), re(), l.settings.navKeyboard && (document.body.addEventListener("keydown", G), document.body.addEventListener("keyup", (() => {
    ...
    const ce = function(e) {
        ...
        return t.close = K, t.next = U, t.prev = _, t.open = de, t.settings = o,
            function(e, t) {
