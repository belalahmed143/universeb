...
__d("TransportSelectingClientUtils", ["BladeRunnerInstrumentedStreamHandler", "MQTTRequestStreamUtils", "TransportSelectingClientCCResolver", "gkx", "regeneratorRuntime"], (function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("TransportSelectingClient", ["BladeRunnerDeferredClient", "DGWEnvUtil", "RequestStreamHandler", "TransportSelectingClientCCResolver", "TransportSelectingClientUtils", "cr:1987488", "regeneratorRuntime"], (function(a, b, c, d, e, f, g) {
    a = function() {
        function a() {
            this.$1 = null
        }
            ...
            return b("regeneratorRuntime").async(function(o) {
                while (1) switch (o.prev = o.next) {
                    case 0:
                        ...
                        if (!(b("cr:1987488") != null && c("DGWEnvUtil").isDGWEnvCompatible() && !d("TransportSelectingClientUtils").isBlockedMethod(j))) {
                            o.next = 16;
                            break
                        }
                        o.next = 5;
                    ...
                    case 5:
                        k = o.sent;
                        if (!(d("TransportSelectingClientUtils").isDGWStream(k) || c("DGWEnvUtil").isDGWAsDefault() || d("TransportSelectingClientUtils").isDGWAllowedSKYTopic(k))) {
                            o.next = 16;
                            break
                        }
                        o.next = 9;
                    ...
                    case 9:
                        l = o.sent;
                        o.next = 12;
                        return b("regeneratorRuntime").awrap(b("cr:1987488").createStream(a, e, g, i, {
                            upsampleMultiplier: l
                        }));
                    case 12:
                        m = o.sent;
                        o.next = 15;
                        return b("regeneratorRuntime").awrap(m.start());
                    case 15:
...
__d("processRelayPrefetchURIsPayload", ["ExecutionEnvironment", "gkx", "promiseDone"], (function(a, b, c, d, e, f, g) {
    "use strict";
    ...
    function a(a) {
        ...
        a.forEach(function(a) {
            ...
            if (typeof a === "string") {
                var b = new Image();
                b.src = a;
                c("gkx")("1601") && typeof((a = b) == null ? void 0 : a.decode) === "function" && c("promiseDone")(b.decode().then(function() {
                    b = null
                }))
            }
        })
...
__d("createRelayFBNetwork", ["DTSG", "Promise", "cr:1110430", "gkx", "isPromise", "killswitch", "processRelayPrefetchURIsPayload", "processRelaySRPayload", "relay-runtime", "withLive", "withLiveClientPolling"], (function(a, b, c, d, e, f, g) {
    ...
    function i(a, b, e, f, g, h) {
        ...
        c("gkx")("1906451") && (a.prefetch_uris = null, a.prefetch_uris_v2 = null);
        i != null && Array.isArray(i) && c("processRelayPrefetchURIsPayload")(i);
        a.prefetch_dash_segments;
        i = a.all_video_dash_prefetch_representations;
        c("gkx")("1906451") && (a.prefetch_dash_segments = null, a.all_video_dash_prefetch_representations = null, a.video_dash_prefetch_representations = null);
...
__d("RelayAPIRequest", ["invariant", "NetworkStatus", "URI", "XHRHttpError", "XHRRequest", "createChunkedResponseParser", "createRelayChunkedResponseParser", "forEachObject", "getRelayAPIRequestHandler", "getSameOriginTransport", "warning"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a(a, c, d) {
            this.$1 = !1, this.setURI(a), this.setMethod("POST"), this.setTransportBuilder(b("getSameOriginTransport")), this.$15 = c, this.$16 = d
        }
        var c = a.prototype;
        c.setURI = function(a) {
            this.$1 && g(0, 2124);
        ...
        c.send = function() {
            ...
            var c, d = 0,
                ...
                k = function() {
                    ...
                    e = Date.now();
                    var g;
                    a.$11 ? (g = b("createRelayChunkedResponseParser")(a.$11, a.$10), g = b("getRelayAPIRequestHandler")(g)) : a.$12 && (g = b("createChunkedResponseParser")(a.$12, a.$10), g = b("getRelayAPIRequestHandler")(g));
                    var k = a.$13,
                        l = function(a) {
                        ...
                        o = new(b("XHRRequest"))(a.$2).setMethod(a.$3).setData(a.$4).setTransportBuilder(a.$9).setErrorHandler(l).setResponseHandler(g).setTimeout(a.$16).setTimeoutHandler(n);
...
__d("createRelayFBNetworkFetch", ["invariant", "DTSGParser", "RelayAPIConfig", "RelayAPIRequest", "RelayDiskCacheConfig", "RelayGraphQLRequestUtils", "RelayPrefetchedResponseProvider", "RelayRuntime", "RelayWWWInitialRolloutResolver", "getAnalyticsTags", "getAsyncParams", "getCrossOriginTransport", "getSameOriginTransport", "nullthrows"], (function(a, b, c, d, e, f, g) {
    ...
    function o(b, c) {
        ...
        for (var f in c) Object.prototype.hasOwnProperty.call(c, f) && d.append(f, c[f]);
        return d
    }
            ...
            (!m(e) || k == null) && (k = function() {
                ...
                next: function(i) {
                    ...
                    r ? k.setResponseBatchChunkHandler(function(a) {
                        ...
                        try {
                            b("DTSGParser").updateFromAsyncResponse(a), c = b("RelayGraphQLRequestUtils").parsePayload(a)
                        } catch (a) {
                            return s.error(a)
                        }
                        if (!c) return s.error(j.createWarning("EmptyResponseError", "Parsed network response is empty. %s(%s)", e.name, e.id || ""));
                        if (c.errors)
                            for (var a = c.errors, f = Array.isArray(a), g = 0, a = f ? a : a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                                var h;
                                if (f) {
                                    if (g >= a.length) break;
                                    h = a[g++]
