...
__d("MqttConnection", ["MqttConnectionHookCollection", "MqttEnv", "MqttProtocolClient", "MqttPublishListener", "MqttTypes", "MqttUserName", "MqttUtils", "NetworkStatus", "Promise", "qex"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        e.subscribe = function(a) {
            this.$17.add(a);
            this.ensureConnected(m) && this.$33(a);
            return !0
        };
        e.publish = function(a, e, f, g) {
            if (!this.$22 && a == o) {
                var h;
                this.$22 = !0;
                this.$20 = (h = c("qex")._("658")) != null ? h : this.$21;
                this.$21 = (h = c("qex")._("659")) != null ? h : this.$21
            }
            var i = {
                resolve: function() {},
                reject: function(a) {}
            ...
            var j = this.ensureConnected(l);
            !j ? (g == null ? void 0 : g.onEvent(d("MqttPublishListener").MqttPublishEvent.NOT_CONNECTED), i.reject(new Error("Client disconnected"))) : this.$34(a, e, f, i);
            return h
        };
        e.unsubscribe = function(a) {
            this.$17["delete"](a);
            this.ensureConnected(n) && this.$35(a);
            return !0
        };
        ...
        e.$29 = function(a) {
            ...
            try {
                ...
                this.$10.bumpCounter("js_error_in_init_exception"), this.$37("Disconnected"), this.$48(!1, !1, e, f, [], a, 14, "init error - " + b.message), b && this.$10.logErrorWarn(b, "ws_js_error"), this.$27.onWSFatal(), this.$49(new(d("MqttTypes").MqttChannelError)(!1, "ws_js_error", b), "client_init")
            }
        };
        e.$39 = function() {
            var a = this.$4(),
        ...
        e.$50 = function(a) {
            ...
            this.$23 = d("MqttEnv").Env.setTimeout(function() {
                b.$29()
            }, e);
            this.$12 += 1
        };
        ...
        e.$42 = function(a, b, c, d, e, f) {
            var g = a.mqttError;
            f = f != null ? g.errorMessage + " - " + f : g.errorMessage;
            ...
            e && this.$10.bumpCounter("protocol.fastreconnectfailure");
            this.$27.onConnectFailure();
            this.$48(!1, a.connAck != -1, b, c, d, e, g.errorCode, f);
            if (a.connAck != null) {
        ...
        e.$30 = function() {
            ...
            c("NetworkStatus").onChange(function(b) {
                b = b.online;
                b && a.$11 === "Disconnected" && (a.$23 != null && (d("MqttEnv").Env.clearTimeout(a.$23), a.$23 = null), a.$29(!0))
            })
        };
        return a
    }();
...
__d("MqttChannel", ["ChannelClientID", "IrisSubscribeChecker", "MqttAnalyticsHook", "MqttConnection", "MqttEnv", "MqttPublishListener", "MqttPublishTimeoutConfig", "MqttUserName", "MqttUtils", "Promise", "isFastRefreshEnabledForCurrentDomain", "promiseDone", "qex", "requireDeferred"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        e.$28 = function(a) {
            a.attempt += 1, c("MqttUtils").promiseDone(this.$27(a.topic, a.payload, a.options.qos, a.options.listener, a.attempt), function() {
                a.ack.resolve()
            }, function(b) {
                a.ack.reject(b)
            })
        ...
        e.$30 = function(a) {
            var b = this;
            a.attempt += 1;
            c("MqttUtils").promiseDone(this.$27(a.topic, a.payload, a.options.qos, a.options.listener, a.attempt), function() {
                return b.$31(a)
            }, function(a) {})
        };
        e.$27 = function(a, b, e, f, g) {
            var h = this,
                i, j, k = this.getConnectionState(),
                l = Date.now();
            !this.$10.canPublish() && this.$13 && this.$13.canPublish() ? (i = this.$13.publish(a, b, e), j = "lp", f != null && (i = i.then(function() {
                return f.onEvent(d("MqttPublishListener").MqttPublishEvent.SENT)
            })), this.$11.bumpCounter("try_publish_lp")) : (i = this.$10.publish(a, b, e, f), j = "ws", this.$11.bumpCounter("try_publish_ws"));
            c("promiseDone")(i, function() {
                h.$11.eventLogOutgoingPublish({
                    sessionID: h.$10.getSessionId(),
                    topic: a,
                    qos: e,
...
__d("RequestStreamE2ELogger", ["ConstUriUtils", "RequestStreamE2EClientLoggerEvent", "RequestStreamE2EClientLoggerMessageType", "RtiRequestStreamE2eClientBatchFalcoEvent", "RtiRequestStreamE2eClientFalcoEvent", "gkx"], (function(a, b, c, d, e, f, g) {
    ...
    var k = function() {
        ...
        var b = a.prototype;
        b.logE2EEvent = function(a, b, c, d, e) {
            c === void 0 && (c = null);
            d === void 0 && (d = null);
            e === void 0 && (e = null);
...
__d("BladeRunnerSocket", ["BladeRunnerEventHandler", "BladeRunnerLogger", "BladeRunnerStreamStatus", "BladeRunnerTypes", "BladeRunnerTypesInternal", "CurrentUser", "FBMqttChannel", "MqttPublishListener", "Promise", "RequestStreamE2EClientLoggerEvent", "RequestStreamE2EClientLoggerMessageType", "RequestStreamE2ELogger", "RequestStreamTransport", "justknobx", "uuid"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        e.processBatch = function(a) {
            try {
                d("RequestStreamE2ELogger").logRequestStreamE2EEventStatic(a.getInstrumentationData(), d("RequestStreamTransport").RequestStreamTransport.WEB_BR_MQTT, c("RequestStreamE2EClientLoggerMessageType").RESPONSE, c("RequestStreamE2EClientLoggerEvent").RECEIVED, p(a));
        ...
        e.$33 = function(a) {
            ...
            if (a.response) {
                ...
                if (!this.$27()) {
                    ...
                    return
                }(f = this.$6) == null ? void 0 : f.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").RESPONSE, c("RequestStreamE2EClientLoggerEvent").RECEIVED, q(a.response), e, String(this.$17));
                f = a.response.delta;
                ...
                (f = this.$6) == null ? void 0 : f.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").RESPONSE, c("RequestStreamE2EClientLoggerEvent").SENT, {}, e, String(this.$17));
                a.response.ack_level === d("RequestStreamCommonRequestStreamCommonTypes").AckLevel.Device && a.response.response_id != null && this.$34(a.response.response_id, e)
            } else {
                (f = this.$6) == null ? void 0 : f.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").RESPONSE, c("RequestStreamE2EClientLoggerEvent").FAILURE, {
...
__d("StreamIdGenerator", ["err"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a() {
            this.$1 = new Set();
            for (var a = 0; a <= h; ++a) this.$1.add(a)
        }
        var b = a.prototype;
    ...
    b = function() {
        ...
        b.streamIdAvailable = function() {
            return this.$1.size > 0 || this.$2 < i
        };
        return a
    }();
    g.MAX_STREAM_ID = i;
    g.SmallStreamIdGeneratorImpl = a;
    g.StreamIdGeneratorImpl = b
}), 98);
__d("StreamGroupWebSocketTransport", ["DGWConstants", "DGWExponentialBackoff", "DGWLoggingContext", "DGWPinger", "DGWStream", "DGWStreamGroupCallbacks", "DGWTransportEvents", "DGWUtils", "DGWWebSocketTransport", "GroupedStream", "Promise", "StreamIdGenerator", "err", "regeneratorRuntime"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a(b, e, f, g, h, i, j, k) {
            var l = this;
            this.$14 = h;
            this.$16 = this.__getStreamIdGenerator(g.dgwVersion < d("DGWConstants").DgwVersion.DGWVER_BIG_IDS);
            this.$5 = new Map();
            this.$6 = new Map();
        ...
        e.__getStreamIdGenerator = function(a) {
            return a == null || a === !1 ? new(d("StreamIdGenerator").SmallStreamIdGeneratorImpl)() : new(d("StreamIdGenerator").StreamIdGeneratorImpl)()
        };
        return a
    }();
    ...
    a = function() {
        function a(a, c, d, e, f, j, k, l, m) {
            ...
            this.$23 = function() {
                try {
                    if (!n.$29()) return;
                    n.$5.debugTrace("LongPollingRunner", "_startPollingIfNecessary called");
                    var a = n.$30();
                    n.$14 = a;
                    var c = n.$9(),
                        d = n.$10();
        ...
        c.onConnectionDisconnect = function() {};
        ...
        c.$28 = function() {
            var a = h.genGk(i.mqtt_lp_no_delay),
                ...
                d = h.genGk(i.mqtt_enable_long_polling_after_ws_success);
