...
__d("createTrustedScriptURLFromFacebookURI", ["TrustedTypesWithNoDefaultPolicies", "URI", "err", "isCdnURI", "isFacebookURI"], (function(a, b, c, d, e, f, g) {
    "use strict";
    b = function(a) {
        return a
    };
...
__d("FalcoLoggerTransports", ["AnalyticsCoreData", "Banzai", "JSResource", "ODS", "PersistedQueue", "Queue", "WebSession", "performanceAbsoluteNow", "promiseDone", "uuid"], (function(a, b, c, d, e, f, g) {
    ...
    function z(a, b) {
        G(b.item.name, "js.br.add_to_batch", 1, !0);
        var c = b.item.extra.length;
        r + c > h && (clearTimeout(s), A());
        q.push([a, b]);
        r += c
    }
    ...
    function A() {
        ...
        t = !1;
        var a = q;
        E("js.br.send_batch", a.map(function(a) {
            return a[1].item
        }));
        l.enqueue(function(b) {
            return b.log(a.map(function(a) {
                ...
                if (!b) {
                    F("js.br.banzai_fallback", a.length);
                    var c = function() {
                        var c = a[d],
                            b = c[0],
                            e = c[1];
                        H.log([e.item], function(a) {
                ...
                for (var c = 0; c < a.length; c++) {
                    var e = a[c],
                        f = e[0];
                    e = e[1];
                    G(e.item.name, "js.br.success_callback.batch.send_batch", 1, !0);
                    f.markItem(e, b)
                }
            })
        });
    ...
    function D(a, b) {
        for (var e = 0; e < a.length; e++) {
            var f, g = a[e];
            G(g.name, "js.banzai.posting_event", 1, !1);
        ...
        E("planes.banzai.write_to_transport", a)
    }
    ...
    var H = {
        log: function(a, b) {
            E("js.banzai.post.log", a), D(a, c("Banzai").BASIC), b(!0)
        },
        logImmediately: function(a, b) {
            E("js.banzai.post.log_immediately", a), D(a, c("Banzai").VITAL), b(!0)
        },
        logCritical: function(a, b) {
            E("js.banzai.post.log_critical", a), D(a, {
                signal: !0,
                retry: !0
            }), b(!0)
        }
    ...
    function I(a) {
        var b = J(a, "banzai_data_loss", "log"),
            d = J(a, "banzai_data_loss", "logImmediately"),
            e = J(a, "banzai_data_loss", "logCritical"),
            f = J(a, "bladerunner_data_loss", "");
        l.enqueue(function(a) {
            return a.log([f], function(a) {
                G("bladerunner_data_loss", "js.br.success_callback.batch.br_data_loss", 1, !0)
            })
        });
        D([b], c("Banzai").BASIC);
        D([d], c("Banzai").VITAL);
    ...
    function M() {
        ...
        c("JSResource").loadAll([c("JSResource")("TransportSelectingClientSingleton").__setRef("FalcoLoggerTransports"), c("JSResource")("RequestStreamCommonRequestStreamCommonTypes").__setRef("FalcoLoggerTransports")], function(a, b) {
            ...
            b = {
                ...
                onFlowStatus: function(a) {
                    a === e.Started && l.start(function(a) {
                        return a({
                            log: function(b, a) {
                                E("planes.bladerunner.write_to_transport", b);
                                var d = JSON.stringify(B(b));
                                f ? c("AnalyticsCoreData").enable_ack ? c("promiseDone")(f.amendWithAck(d), function() {
                                    E("planes.bladerunner.ack_received", b), a(!0)
                                }, function() {
                                    E("planes.bladerunner.ack_failure", b), a(!0)
                                }) : (f.amendWithoutAck(d), E("planes.bladerunner.write_without_ack", b), a(!0)) : E("planes.bladerunner.request_stream_null", b)
                            },
            ...
            c("promiseDone")(a.requestStream({
                method: "Falco"
            }, JSON.stringify(C(d("WebSession").getId())), b, {
                requestId: ""
            }).then(function(a) {
                f = a
            })["catch"](function(a) {
        ...
        c("AnalyticsCoreData").enable_dataloss_timer && (K(), L());
        u = !0
    }
    ...
    function a() {
        ...
        c("PersistedQueue").setHandler("falco_queue_log", function(a) {
            ...
            while (b = a.dequeueItem())(function(b) {
                N(b.item.policy) ? (G(b.item.name, "js.use_bladerunner.log", 1, !0), M(), s == null && (s = setTimeout(A, i)), z(a, b)) : (G(b.item.name, "js.use_banzai.log", 1, !0), H.log([b.item], function(c) {
        ...
        c("PersistedQueue").setHandler("falco_queue_immediately", function(a) {
            var b;
            while (b = a.dequeueItem())(function(b) {
                N(b.item.policy) ? (G(b.item.name, "js.use_bladerunner.log_immediately", 1, !0), M(), (s == null || !t) && (clearTimeout(s), s = setTimeout(A, j), t = !0), z(a, b)) : (G(b.item.name, "js.use_banzai.log_immediately", 1, !0), H.logImmediately([b.item], function(c) {
                    return a.markItem(b, c)
                }))
            })(b)
        });
        c("PersistedQueue").setHandler("falco_queue_critical", function(a) {
            ...
            while (b = a.dequeueItem())(function(b) {
                var c = b.item;
                N(c.policy) ? (G(c.name, "js.use_bladerunner.log_critical", 1, !0), M(), l.enqueue(function(d) {
                    return d.logCritical([c], function(c) {
                        G(b.item.name, "js.br.success_callback.batch.critical", 1, !0), a.markItem(b, c)
                    })
                })) : (G(c.name, "js.use_banzai.log_critical", 1, !0), H.logCritical([c], function(c) {
                    return a.markItem(b, c)
                }))
            })(b)
        })
...
__d("ControlledReferer", ["Bootloader", "CookieConsent", "XRefererFrameController", "getRequestConstUri", "isInstagramURI", "isMessengerDotComURI", "isOculusDotComURI", "isWhatsAppBlogURI", "isWorkplaceDotComURI", "justknobx", "lowerFacebookDomain"], (function(a, b, c, d, e, f, g) {
    function h(a, b, d) {
