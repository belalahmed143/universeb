/*1646726439,,JIT Construction: v1005162658,en_US*/
...
try {
            ...
            with(this) {
                ...
                __d("sdk.Frictionless", ["sdk.Auth", "sdk.Dialog", "sdk.Event", "sdk.api"], (function(a, b, c, d, e, f, g) {
                    var h = {
                        ...
                        init: function() {
                            h._useFrictionless = !0, c("sdk.Auth").getLoginStatus(function(a) {
                ...
                __d("legacy:fb.auth", ["FB", "Log", "sdk.Auth", "sdk.Cookie", "sdk.Event", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.feature", "sdk.ui", "sdk.warnInsecure"], (function(a, b, c, d, e, f) {
                    b("FB").provide("", {
                    ...
                    c.subscribe("init:post", function(a) {
                        ...
                        if (b("sdk.Runtime").getClientID() && b("sdk.Runtime").getUseCookie()) {
                            b("sdk.feature")("log_cookies_usage", !1) && b("sdk.Scribe").log("jssdk_error", {
                                appId: b("sdk.Runtime").getClientID(),
                ...
                __d("sdk.Canvas.Plugin", ["Log", "sdk.RPC", "sdk.Runtime", "sdk.UA", "sdk.api"], (function(a, b, c, d, e, f, g) {
                    ...
                    c("sdk.RPC").local.hidePluginObjects = function() {
                        d("Log").info("hidePluginObjects called"), r({
                            state: "opened"
                        })
                    };
                    c("sdk.RPC").local.showPluginObjects = function() {
                        d("Log").info("showPluginObjects called"), r({
                            state: "closed"
                        })
                    };
                ...
                __d("sdk.XFBML.ShadowDOMLoginButton", ["DOMPlugin", "sdk.Auth", "sdk.Event", "sdk.LoggingUtils", "sdk.PluginUtils", "sdk.Runtime", "sdk.SVGLogos", "sdk.SharedStringConstants", "sdk.ui"], (function(a, b, c, d, e, f, g) {
                    var h = {
                            small: "11px",
                            medium: "13px",
                            large: "16px"
                    ...
                    a = function(a) {
                        ...
                        e.applyStyles = function(a, b) {
                            var c;
                            c = (c = d("sdk.PluginUtils").getVal(b, "size")) != null ? c : "large";
                ...
                __d("sdk.XFBML.LoginButton", ["IframePlugin", "Log", "guid", "safeEval", "sdk.Auth", "sdk.Dialog", "sdk.ErrorHandling", "sdk.Impressions", "sdk.PluginUtils", "sdk.Runtime", "sdk.Scribe", "sdk.UIServer", "sdk.XD", "sdk.XFBML.ShadowDOMLoginButton", "sdk.feature", "sdk.getContextType", "sdk.modFeatureCheck", "sdk.ui"], (function(a, b, c, d, e, f, g) {
                    var h = c("sdk.feature")("https_only_learn_more", "");
                    ...
                    a = c("IframePlugin").extend({
                        constructor: function(a, b, e, f) {
                            if ((f["data-use-continue-as"] == null || f["data-use-continue-as"] != "true") && d("sdk.modFeatureCheck").forIDs("allow_shadow_dom_for_apps_with_id", [c("sdk.Runtime").getClientID()]) && c("sdk.feature")("allow_shadow_dom", !1) == !0) return new(c("sdk.XFBML.ShadowDOMLoginButton"))(a, b, e, f, {
                                width: "string",
                                size: "string",
                                "button-type": "string",
                                layout: "string",
                ...
                __d("legacy:fb.xfbml.plugins", ["IframePlugin", "PluginConfig", "PluginTags", "XFBML", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.CustomerChatWrapper", "sdk.XFBML.LWIAdsCreation", "sdk.XFBML.LWIAdsInsights", "sdk.XFBML.LoginButton", "sdk.XFBML.Save", "sdk.XFBML.ShareButton", "sdk.XFBML.Video", "sdk.feature"], (function(a, b, c, d, e, f) {
                    var g = {
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "xfbml.customerchat.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1005162658","namespace":"FB","message":"' + e.message + '"}}');
